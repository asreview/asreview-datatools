...
[algorithm](https://github.com/asreview/asreview/blob/master/asreview/data/base.py#L461-L505). The algorithm first removes all duplicates based on a persistent
