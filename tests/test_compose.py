...
class TestCompose(unittest.TestCase):
    ...
    input_files_1 = [path_dataset_1_csv, path_dataset_1_csv, path_dataset_1_csv, path_dataset_1_csv]
    ...
    def test_suffixes(self):
        self.assertRaises(ValueError, compose, 'output/unit_test.csv', input_files_1, pid="doi", order="riu",
                          resolve="continue")
